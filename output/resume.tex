...
\startxcell yleh.top>
email：\useURL[url1][mailto:kayleh@foxmail.com][][kayleh@foxmail.com]\from[url1] \stopxcell
\stopxrow
\stopxtablebody
...
\startblockquote
个人网站：\useURL[url2][https://www.kayleh.top]\from[url2]
...
\subsection[title={技能},reference={技能}]
